...
const { generateNextProd } = require("./createNextStructure.js");

function Next(pwd, tailwind, ts, pName) {
    generateNextProd(pwd, tailwind, ts, pName);
}

const { generateReactProd } = require("./createReactStructure.js");

function React(pwd, tailwind, ts, pName) {
    generateReactProd(pwd, tailwind, ts, pName);
}


module.exports = { Static, Next, React };